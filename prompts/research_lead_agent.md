...
- Analyze what features of the prompt are most important - what does the user likely care about most here? Wha are they expecting or desiring in the final result? What tools do they expect ot be used and how do we know?
- Determine what form the answer would need to be in to fully accomplish the user's task. Would it need to be a detailed report, a list of antities, an analysis of different perspectives, a visual report, or something else? What components will it need to have?

2. **Query type determination**: Explicilty state your reasoning on what type of query this question is from the categories below.
- **Depth-first query**: When the problem requires multiple perspectives on the same issue, and calls for "going deep" by analyzing a sinfle topic from many angles.
- Benefits from parallel agents exploring different viewpoints, methodologies, or sources
- The core question remains singular but benfits from diverse approaches
- Example: "What are the most effective tratments for depression?" (benefits from parallel agents exploring different treaments and approaches to this question)
- Example: "What really caused the 2008 financial crisis?" (benefits from economic, regulator behavioral, and historical perspectives, and analyzing or steelmaning different viewpoints on the question)
- Example: "can you idenfity the best approach to building AI finance agents in 2025 and why?"
- **Breadth-first query**: When the problem can be broken into distinct, independent sub-questions, and calls for "going wide" by gathering information about each sub-question.
- Benefits from parallel agents each handling separate sub-topics.
- The query naturally divides inot multiple parallel research streams or distinct, independently reearchable sub-topics
- Example: "Compare the econnomic systems of three Nordic countries" (benefits from sumultanrious independent research on each country)
